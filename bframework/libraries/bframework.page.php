...
*/  
function bframework_page_default($title = '' , $body = '' , $header = '', $footer = '',$head = ''){
$page['body'] = $body;
$page['header'] = $header;
$page['footer'] = $footer;
$page['title'] = $title;
...
*/ 
function bframework_view_page($params = array()){
...
bframework_page_default($title,$body,$header,$footer,$head);   
}
